...
dudz = reshape(mp.dudzm,1,1,[]);
	...
	S_13=0.5*( mn.lse(1:end,1:end,1:end,8) + mn.lse(1:end,1:end,1:end,12)+dudz );
	...
	O_13 = 0.5*(mn.lse(1:end,1:end,1:end,12)+dudz - mn.lse(1:end,1:end,1:end,8))  ;
