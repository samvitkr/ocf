...
class DualFilterSiren(nn.Module):
    def __init__(self):
        super().__init__()
        # Note: omega_0=1.0 matches your "smooth blob" training settings
...
def generate_filters():
    ...
    with torch.no_grad():
        for i in range(0, num_points, batch_size):
            ...
            # --- CRITICAL FIX: SIGMOID instead of Softmax ---
            # Softmax enforces sum=1 (mutually exclusive).
            # Sigmoid allows both to be 0 (clean white background).
    ...
    # Col 0 = Intensity of Class 0 (Positive Region)
    # Col 1 = Intensity of Class 1 (Negative Region)
